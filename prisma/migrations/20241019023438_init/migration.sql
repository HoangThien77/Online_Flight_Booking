...
INSERT INTO "new_Ticket" ("airline", "arrivalAirport", "arrivalTime", "bookingId", "departureAirport", "departureTime", "flightNumber", "id", "seatNumber", "total_duration", "travelClass", "tripType") SELECT "airline", "arrivalAirport", "arrivalTime", "bookingId", "departureAirport", "departureTime", "flightNumber", "id", "seatNumber", "total_duration", "travelClass", "tripType" FROM "Ticket";
DROP TABLE "Ticket";
